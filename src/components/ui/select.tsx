...
> & {
  /** Hide Radix scroll chevrons (avoids layout jump on scroll). */
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          hideScrollButtons ? 'overflow-y-hidden' : 'overflow-y-auto',
          position === 'popper' &&
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            ...
            hideScrollButtons && position === 'popper' && 'overflow-y-auto',
            viewportClassName,
          )}
        >
          {children}
