...
- [x] **Task 3: Integrate "Play" Button in Lesson List** (AC: #1, #2)
  - [x] 3.1 Create `src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/PlayButton/` directory with index.tsx, connect.ts, types.ts
  ...
  - [x] 3.4 Modify `src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/index.tsx` to add PlayButton
...
- `src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/PlayButton/index.tsx` - Play trigger
- `src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/PlayButton/connect.ts` - Play button logic
- `src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/PlayButton/types.ts` - Button types

### Files to Modify

- `src/components/ClientLayout.tsx` - Add AudioPlayerProvider wrapper
- `src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/index.tsx` - Add PlayButton to lesson row
...
- [Source: src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/] - Lesson row integration point

## Dev Agent Record

### Context Reference

Loaded from sprint-status.yaml, story file, ClientLayout.tsx, SortableLessonItem/index.tsx, and models.ts
...
- src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/PlayButton/index.tsx
- src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/PlayButton/connect.ts
- src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/PlayButton/types.ts

**Modified:**

- src/components/ClientLayout.tsx (added AudioPlayerProvider and AudioPlayer)
- src/containers/Main/CourseDetail/SortableLessonList/SortableLessonItem/index.tsx (added PlayButton)
